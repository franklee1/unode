...
class CMainParams : public CChainParams
{
  public:
    CMainParams()
    {
        ...
        const char *pszTimestamp = "The final score of Feb 2018 righ one, Correct";
...
//        printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
  //     printf("merkle = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0x251e926a11f67aa209afee14e9f57228b9a20bb8bfd35c7bd8720bedc7918102"));
        assert(genesis.hashMerkleRoot == uint256("0x4f2091838b8690352ff4819731c8b16837585e97be1415423ebe8ddb92a14003"));
